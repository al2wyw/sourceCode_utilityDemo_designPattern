 ...
 * 
 */
@WebServiceClient(name = "testService", targetNamespace = "http://www.myws.com", wsdlLocation = "file:/C:/Users/Administrator/git/jaxws/spring_jaxws/wsdl/TestService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICE_QNAME = new QName("http://www.myws.com", "testService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Administrator/git/jaxws/spring_jaxws/wsdl/TestService.wsdl");
     ...
     * 
     * @return
     *     returns AnnotationTest
     */
    @WebEndpoint(name = "annotation_testPort")
    public AnnotationTest getAnnotationTestPort() {
        return super.getPort(new QName("http://www.myws.com", "annotation_testPort"), AnnotationTest.class);
    }
     ...
     */
    @WebEndpoint(name = "annotation_testPort")
    public AnnotationTest getAnnotationTestPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.myws.com", "annotation_testPort"), AnnotationTest.class, features);
    }
