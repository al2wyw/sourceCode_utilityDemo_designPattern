 ...
 *       &lt;attribute name="suppChargeType" use="required" type="{http://www.trip.com/webservices/}ChargeType" />
...
@XmlType(name = "Supplement", namespace = "http://www.trip.com/webservices/")
@XmlSeeAlso({
