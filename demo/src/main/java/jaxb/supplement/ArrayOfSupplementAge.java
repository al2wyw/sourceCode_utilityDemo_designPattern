 ...
 *       &lt;sequence>
 *         &lt;element name="SupplementAge" type="{http://www.trip.com/webservices/}SupplementAge" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ArrayOfSupplementAge", namespace = "http://www.trip.com/webservices/", propOrder = {
    "supplementAge"
})
public class ArrayOfSupplementAge {

    @XmlElement(name = "SupplementAge", namespace = "http://www.trip.com/webservices/")
